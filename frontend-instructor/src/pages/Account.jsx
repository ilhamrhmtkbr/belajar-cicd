            ...
            {loading ? <div className={'loading-spinner'}></div> :
                <form className={'card-wrapper max-width-600'}
                    ...
                    <div className="max-width-500">
                        ...
                        <small className={'max-width-500'}
                               style={{display: 'block'}}>{t('inst_account_explanation_1')}</small>
                    ...
                    <div className="max-width-500">
                        ...
                        <small className={'max-width-500'}
                               style={{display: 'block'}}> {t('inst_account_explanation_2')}</small>
                                    ...
                                    {banks && Object.entries(banks).map(([code, name], index) => (
                                        <div key={index}
                                            ...
                                            <div>
                                                ...
                                                <p className={'max-width-500'} style={{overflow: 'auto'}}>{name}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                    ...
                    <div className="max-width-500">
                        ...
                        <small className={'max-width-500'}
                               style={{display: 'block'}}>{t('inst_account_explanation_3')}</small>
