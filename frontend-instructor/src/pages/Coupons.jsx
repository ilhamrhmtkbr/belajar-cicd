            ...
            <form className={'card-wrapper max-width-700 margin-top-l'}
                ...
                {formMode === 'add' ?
                    <div className="max-width-500">
                        ...
                        <small style={{display: 'block'}}>{t('inst_coupons_form_id')}</small>
                ...
                <div className="max-width-500">
                    ...
                    <small style={{display: 'block'}}>{t('inst_coupons_form_discount')}</small>
                ...
                <div className="max-width-500">
                    ...
                    <small style={{display: 'block'}}>{t('inst_coupons_form_max_redemptions')}</small>
                ...
                <div className="max-width-500">
                    ...
                    <small style={{display: 'block'}}>{t('inst_coupons_form_expiry_date')}</small>
