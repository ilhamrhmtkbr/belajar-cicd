                ...
                <div className={'card-layout w-full'}>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        ...
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{loadingAnswers ? 'Loading...' : answers?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('courses_likes')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{loadingCourseLikes ? 'Loading...' : courseLikes?.data?.length ?? 0}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('courses')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{loadingCourses ? 'Loading...' : courses?.meta?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('reviews')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{loadingReviews ? 'Loading...' : courseReviews?.meta?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('earnings')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{loadingEarnings ? 'Loading...' : earnings?.meta?.total}</div>
                    </div>
                </div>
