            ...
            <>
                ...
                <div className={'card-layout w-full'}>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        ...
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{cartsLoading ? 'Loading...' : carts?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('certificates')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{certificatesLoading ? 'Loading...' : certificates?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('courses')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{coursesLoading ? 'Loading...' : courses?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('reviews')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{reviewsLoading ? 'Loading...' : reviews?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('questions')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{questionsLoading ? 'Loading...' : questions?.total}</div>
                    </div>
                    <div className={'card-wrapper replace-shadow-with-border'}>
                        <h3 className={'capitalize'}>{t('transactions')}</h3>
                        <div className={'badge badge-small bg-primary'}
                             style={{color: 'white'}}>{transactionsLoading ? 'Loading...' : transactions?.total}</div>
                    </div>
                </div>
